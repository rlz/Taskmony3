...
namespace Taskmony.Migrations
{
    ...
    [Migration("20230412203458_AddRecurrencePatternTable")]
    partial class AddRecurrencePatternTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taskmony.Models.Assignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Taskmony.Models.RecurrencePattern", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Taskmony.Models.Assignment", b =>
                {
                    ...
                    b.HasOne("Taskmony.Models.Task", "Task")
                        .WithOne("Assignment")
                        .HasForeignKey("Taskmony.Models.Assignment", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Taskmony.Models.RecurrencePattern", b =>
                {
                    b.HasOne("Taskmony.Models.Task", "Task")
                        ...
                        .HasForeignKey("Taskmony.Models.RecurrencePattern", "TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
